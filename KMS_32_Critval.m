...
a       = 0;
b       = c_B;
psi_a   = KMS_33_Coverage(a,zeros(B,1),ones(B,1),phi_test,f_ineq_keep,f_eq_keep,G_ineq,G_eq,Dg_ineq,Dg_eq,A_rho,b_rho,theta,KMSoptions);
...
psi_b   = KMS_33_Coverage(b,psi_a,ones(B,1),phi_test,f_ineq_keep,f_eq_keep,G_ineq,G_eq,Dg_ineq,Dg_eq,A_rho,b_rho,theta,KMSoptions);
...
for ii = 1:c_maxit
    ...
    psi_s = KMS_33_Coverage(s,psi_a,psi_b,phi_test,f_ineq_keep,f_eq_keep,G_ineq,G_eq,Dg_ineq,Dg_eq,A_rho,b_rho,theta,KMSoptions);
